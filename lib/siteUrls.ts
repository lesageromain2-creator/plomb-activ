...
export const SITE_URLS: { path: string; lastmod: string; priority: number; changefreq: "weekly" | "monthly" }[] = [
  ...
  { path: "/robinetterie", lastmod: "2026-09-24", priority: 0.85, changefreq: "monthly" },
  { path: "/canalisation", lastmod: "2026-09-24", priority: 0.85, changefreq: "monthly" },
  { path: "/groupe-de-securite", lastmod: "2026-09-24", priority: 0.85, changefreq: "monthly" },
